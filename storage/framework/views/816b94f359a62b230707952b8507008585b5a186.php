    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-9 p-5 pt-2">
            <h3 class="page-header">
                <i class="fas fa-box-open mr-2"></i> <b>EDIT PRODUK</b>
            </h3>
            <hr>
            <?php if($errors->any()): ?>
            ...
            <form action="<?php echo e(route('produk.update',$produk->id_produk)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_produk" name="nama_produk" value="<?php echo e($produk->nama_produk); ?>">
                </div>
                <div class="form-group">
                    <label for="deskripsi_produk">Deskripsi</label>
                    <textarea class="form-control" id="deskripsi_produk" name="deskripsi_produk" rows="3"><?php echo e($produk->deskripsi_produk); ?></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="harga_produk" name="harga_produk" value="<?php echo e($produk->harga_produk); ?>">
                </div>
                <div class="form-group">
...
<?php /**PATH F:\TES_STUCK\new\pemesanan\resources\views/admin/edit_produk.blade.php ENDPATH**/ ?>