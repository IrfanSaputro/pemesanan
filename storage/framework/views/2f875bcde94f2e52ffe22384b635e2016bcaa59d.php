    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php $no = 0; ?>
                    <?php $__currentLoopData = $pemesan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pemesan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $no++; ?>
                    <tr>
                        <th scope="row"><?php echo e($no); ?></th>
                        <td><?php echo e($pemesan->nama_pemesan); ?></td>
                        <td><?php echo e($pemesan->alamat_pemesan); ?></td>
                        <td><?php echo e($pemesan->telepon_pemesan); ?></td>
                        <td><?php echo e($pemesan->produk_pemesan); ?></td>
                        <td><?php echo e($pemesan->deskripsi); ?></td>
                        <td><?php echo e($pemesan->harga); ?></td>
                    </tr>
...
<?php /**PATH F:\TES_STUCK\new\pemesanan\resources\views/admin/pemesan.blade.php ENDPATH**/ ?>