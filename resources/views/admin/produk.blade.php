    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3 class="page-header">
                ...
                <a class="btn btn-primary float-right" href="{{ route('produk.create') }}">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ url('img/'.$produk->gambar_produk) }}" alt=""></td>
                        <td>{{ $produk->harga_produk }}</td>
                        <td>
                            <form action="{{ route('produk.destroy',$produk->id_produk) }}" method="POST">
             
                                <a class="btn btn-primary btn-sm" href="{{ route('produk.edit',$produk->id_produk) }}">Edit</a>
